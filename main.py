...
##capture video frames from the defualt camera
...
while True:
    ...
    if process_this_frame:
        ...
        for face_encoding in face_encodings:
            ...
            #computes the distance between a face encoding and a list of know face encodings
            face_distances = face_recognition.face_distance(known_face_encodings, face_encoding)
            #find the index of the smallest distance value and store it in best_match_index
            best_match_index = np.argmin(face_distances)
            #checks to see if best match for a given face encoding is a known face based on the list of known face encodings and names
